...
from .views import (member,member_detail,
                   member_create, user_login, MemberAccountRegister, logout_view, Dashboard,
                   send_message, inbox, view_message, member_inbox, MemberAccountEditView,
                   StaffAccountEditView, AddStaffMemberView, unread_notifications_count, mark_notifications_as_read, MemberDashboardView)
...
urlpatterns = [
        ...
        path('dashboard', MemberDashboardView, name='dashboard'),
