...
class LoanAccount(models.Model):
    owner = models.OneToOneField(Member, on_delete=models.CASCADE, related_name='loan_account')
    loan_type = models.CharField(choices=LOAN_TYPE_CHOICES, max_length=20, default='Loan')
...
#     if kwargs['created']:
#         LoanAccount.objects.create(owner=kwargs['instance'])
